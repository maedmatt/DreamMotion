...
def get_detector() -> ObjectDetector:
    model_id = os.environ.get("G1_VISION_MODEL", "yolov8l-worldv2.pt")
    confidence = float(os.environ.get("G1_VISION_CONFIDENCE", "0.3"))
    return ObjectDetector(model_id=model_id, confidence=confidence)
